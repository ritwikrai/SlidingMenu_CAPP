...
public class FetchThreads extends AsyncTask<String, Void, String> {

	private Context mContext;
	private ProgressDialog mProgressDialog;
	private String TAG = "";

	public FetchThreads(Context mContext) {
	...
	protected String doInBackground(String... params) {
		String response = "";
		try {
			response = Util.postMethodWay_json(Consts.LOGIN_URL, params[0]);
