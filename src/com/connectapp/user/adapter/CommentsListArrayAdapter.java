...
public class CommentsListArrayAdapter extends ArrayAdapter<State> {
	...
	public CommentsListArrayAdapter(Activity context, List<State> list) {
		super(context, R.layout.item_countrycode_row, list);
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			view = inflator.inflate(R.layout.item_countrycode_row, null);
